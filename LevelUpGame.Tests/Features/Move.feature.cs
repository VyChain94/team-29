...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Move in a direction", "    I want to move my character. If they attempt to move \n    past a boundary, th" +
        ...
        public void MoveInADirection(string startingPostionX, string startingPostionY, string direction, string endingPositionX, string endingPositionY, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("startingPostionX", startingPostionX);
            argumentsOfScenario.Add("startingPostionY", startingPostionY);
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 8
        testRunner.Given(string.Format("the character starts at postion with XCoordinates {0}", startingPostionX), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 9
        testRunner.And(string.Format("starts at YCoordinates {0}", startingPostionY), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 10
